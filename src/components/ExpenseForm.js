    ...
    render() {
        return (                
                <form className="form" onSubmit={this.onSubmit}>
                    ...
                    <textarea className="textarea" placeholder="Add a note for your expense (option)" value={this.state.note} onChange={this.onNoteChange}></textarea>                    
                    <div>
                        <button className="button" onClick={this.onAddExpense}>Save Expense</button>
                    </div>
                </form>
            )
    }
